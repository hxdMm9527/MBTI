...
function aggregateScores(
  ...
  questions: Array<{ id: number; dimension: DimensionPair; options: Array<{ value: "A" | "B" | "C" | "D"; weight: Partial<Record<Dimension, number>> }> }>
...
export function getDimensionResults(
  ...
  return dimensions.map(dim => {
    ...
    return {
      ...
      leaning: firstScore >= secondScore ? first : second,
